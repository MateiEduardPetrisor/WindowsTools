...
namespace RemoveThisPcFolders
{
    class RegistryUtils
    {
        ...
        private readonly String[] KeysToRemove3DObjectsX64;
        private readonly String[] KeysToRemove3DObjectsX86;
        private readonly String[] KeysToRemoveX64;
        private readonly String[] KeysToRemoveX86;
        ...
        public RegistryUtils()
        {
            ...
            this.KeysToRemoveX64 = new String[] {
            ...
            this.KeysToRemove3DObjectsX64 = new String[]
            {
               "HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\MyComputer\\NameSpace\\{0DB7E03F-FC29-4DC6-9020-FF41B59E513A}",
               "HKEY_LOCAL_MACHINE\\SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Explorer\\MyComputer\\NameSpace\\{0DB7E03F-FC29-4DC6-9020-FF41B59E513A}"
            };
            this.KeysToRemoveX86 = new String[] {
                "HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\MyComputer\\NameSpace\\{B4BFCC3A-DB2C-424C-B029-7FE99A87C641}",
                "HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\MyComputer\\NameSpace\\{A8CDFF1C-4878-43be-B5FD-F8091C1C60D0}",
                "HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\MyComputer\\NameSpace\\{d3162b92-9365-467a-956b-92703aca08af}",
                "HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\MyComputer\\NameSpace\\{374DE290-123F-4565-9164-39C4925E467B}",
            ...
            this.KeysToRemove3DObjectsX86 = new String[]
            {
                "HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\MyComputer\\NameSpace\\{0DB7E03F-FC29-4DC6-9020-FF41B59E513A}"
            };
        ...
        private void RemoveFolder(String RegistryKeyName)
        {
            Process p = new Process();
            p.StartInfo.FileName = this.RegFullPath;
            p.StartInfo.Arguments = "delete " + RegistryKeyName + " /F";
            p.Start();
            p.WaitForExit();
            p.Dispose();
        }

        public void RemoveAllThisPcFolders()
        {
            if (Environment.GetEnvironmentVariable("PROCESSOR_ARCHITECTURE").ToLower().Equals("amd64"))
            {
                foreach (String RegKey in this.KeysToRemoveX64)
                {
                    Console.WriteLine("Delete Key {0}", RegKey);
                    this.RemoveFolder(RegKey);
                }
                if (this.OsBuild >= 16299)
                {
                    foreach (String RegKey in this.KeysToRemove3DObjectsX64)
                    {
                        Console.WriteLine("Delete Key {0}", RegKey);
                        this.RemoveFolder(RegKey);
                    }
            ...
            {
                foreach (String RegKey in this.KeysToRemoveX86)
                {
                    Console.WriteLine("Delete Key {0}", RegKey);
                    this.RemoveFolder(RegKey);
                }
                if (this.OsBuild >= 16299)
                {
                    foreach (String RegKey in this.KeysToRemove3DObjectsX86)
                    {
                        Console.WriteLine("Delete Key {0}", RegKey);
                        this.RemoveFolder(RegKey);
                    }
